...
1. Remove the install script that puts the block in place for Ubuntu upgrades
2. Update the release-upgrades file in order to allow Ubuntu upgrades
...
sub pre_distro_upgrade ($self) {
    ...
    INFO("Removing install script that blocks upgrades to $pretty_distro_name");
