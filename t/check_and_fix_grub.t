...
subtest "check_and_fix_grub kernel using net.ifnames=0" => sub {
    ...
    ok !$g2->post_elevate(), "grub file is missing";
    ...
    ok $g2->post_elevate(), "check_and_fix_grub need to fixup grub config";
    ...
    ok !$g2->post_elevate(), "do not fix it twice";
...
subtest "check_and_fix_grub kernel without net.ifnames=0" => sub {
    ...
    ok !$g2->post_elevate(), "no need to fix when current kernel does not use net.ifnames=0";
