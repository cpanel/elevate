...

{
    ...
    $mock_elevate->redefine(
        ssystem_capture_output => sub ( $, @args ) {
            ...
            return { stdout => ["2024-03-18 16:45:18.368 ERROR    PID: 2150 leapp.workflow.FirstBoot.enable_rhsm_target_repos: Skipping enabling repositories through subscription-manager due to --no-rhsm or environment variables."], stderr => [] };
        }
    );
